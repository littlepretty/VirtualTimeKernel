...
\begin{itemize}
	...
	\item \texttt{freeze\_start\_ns} represents the starting moment that a process is frozen. It is always zero when the process is not frozen.
	\item \texttt{freeze\_past\_ns} represents the accumulative time, in nanoseconds, that a running process was put into freezing state.
\end{itemize}
