        ...
        do
                ...
                do
                        ...
                        do
                                ...
                                ./plot_cdf.py --bsl_file Sw${n}Lat${delay}Frz${dur}Int${int}Bsl.ping \
                                        --vir_file Sw${n}Lat${delay}Frz${dur}Int${int}Vir.ping \
                                        --label1 "No Freeze: Delay=${delay}us" --label2 "Freeze: D=${dur}s  I=${int}s" \
                                        --topic_name Sw${n}Lat${delay}Frz${dur}Int${int}
                        done
                done
        done
done
